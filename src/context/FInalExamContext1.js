...
export const ProductList = () => {
  ...
  return (
    <div>
      ...
      <Form.Group controlId="formUpdateProductId">
        <Form.Label>Enter Product ID to Update:</Form.Label>
        <Form.Control
          type="text"
      ...
      <Form.Group controlId="formUpdateProductDetails">
        <Form.Label>Enter Product Details to Update:</Form.Label>
        <Form.Control
          type="text"
          placeholder="Title"
          value={updateProductDetails.title || ''}
          onChange={(e) =>
            setUpdateProductDetails((prevDetails) => ({ ...prevDetails, title: e.target.value }))
          }
        />
